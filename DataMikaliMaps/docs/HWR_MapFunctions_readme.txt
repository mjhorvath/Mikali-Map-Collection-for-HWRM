...
• Need to make doubly sure that no overlapping points are created at the 
  corners and edges by the "stitchAdd" function.
• Need a function to duplicate a table.
• The "make" functions need non-randomized equivalents.
• Standardize my maze generation algorithms and move them to here.
